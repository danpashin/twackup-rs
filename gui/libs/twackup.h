...
typedef struct TwPackage {
    ...
    slice_raw_uint8_t (*get_section_string)(TwPackageRef );

    slice_raw_uint8_t (*get_field)(TwPackageRef , TwPackageField_t);

    slice_boxed_uint8_t (*build_control)(TwPackageRef );

    slice_boxed_slice_raw_uint8_t (*get_dependencies)(TwPackageRef );
 ...
 * 
 */
slice_raw_uint8_t tw_package_get_section_string (
 ...
 * 
 */
slice_raw_uint8_t tw_package_get_field (
    TwPackageRef package,
 ...
 *  use the `Option< slice_ptr<_> >` type.
 */
typedef struct slice_ref_TwPackage {

    TwPackage_t const * ptr;

    size_t len;

} slice_ref_TwPackage_t;

typedef struct TwProgressFunctions {

    void (*did_increment)(uint64_t);

    void (*set_message)(slice_raw_uint8_t);

    void (*print_message)(slice_raw_uint8_t);

    void (*print_warning)(slice_raw_uint8_t);

    void (*print_error)(slice_raw_uint8_t);

} TwProgressFunctions_t;
 ...
 * 
 */
slice_boxed_slice_boxed_uint8_t tw_rebuild_packages (
    TwDpkg_t const * dpkg,
    slice_ref_TwPackage_t packages,
 ...
 */
void free_packages_rebuild_result (
    slice_boxed_slice_boxed_uint8_t result);
